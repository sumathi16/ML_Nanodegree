...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            self.epsilon = 0.999 ** self.trail
            #self.epsilon = 1.0/ (self.trail *  self.trail)
            #self.epsilon = math.cos(0.03*self.trail) 
            #self.epsilon = math.exp(-0.0005*self.trail) 
    ...
    def get_maxQ(self, state):
        ...
        maxAction,value = max(self.Q[state], key = lambda x: self.Q[state][x])
    ...
    def choose_action(self, state):
        ...
        # Otherwise, choose an action with the highest Q-value for the current state
            ...
            tie_actions = [act for act in self.valid_actions if self.Q[state][act] == max_val]
